...
### Agent Assignments
- **Auth Agent**: Used for authentication implementation, including user signup/signin using Better Auth and JWT token management
- **Frontend Agent**: Used for frontend development with Next.js 16+ (App Router)
- **DB Agent**: Used for database design and operations with Neon Serverless PostgreSQL using SQLModel ORM
- **Backend Agent**: Used for FastAPI development and API endpoint creation
...
DATABASE_URL= "https://ep-long-dream-ai6h9x2g.apirest.c-4.us-east-1.aws.neon.tech/neondb/rest/v1"